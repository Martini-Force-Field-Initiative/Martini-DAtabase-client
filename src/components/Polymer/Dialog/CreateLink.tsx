...
interface props {
    ItpStore: any, // CustomPolymerStash
   // customITPS: { [name: string]: string },
    close: () => void,
    showCreate: boolean,
    //addConnectionRules: (arg0: string, arg1: string) => void,
}
            ...
            >
                ...
                <DialogContent>
                    ...
                    <SimpleSelect
                        ...
                        variant="standard"
                        values={Object.keys(this.props.ItpStore.list()).map(e => ({ id: e, name: e }))}
                        id="itp1"
                ...
                <DialogActions>
                    <Button onClick={
                        () => { 
                            this.props.ItpStore.addConnectionRules("tempname", this.state.out!)
                            //this.props.addConnectionRules("tempname", this.state.out!); 
                            this.props.close() }
                    }>
                        Add this link
                    </Button>
