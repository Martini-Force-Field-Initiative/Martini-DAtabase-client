...
export default function GeneratorControls(props:GCtrlProps) {
  ...
  return (
    <div className={classes.root} style={{ marginTop:'0.5em', paddingLeft:'2em',
      paddingRight:'2em', paddingBottom:'2em', marginBottom:'0em'
      }}>
      <AppBar position="static" 
        style={{   //#383940
          backgroundColor: 'rgb(255, 244, 229)',
          color:'rgb(102, 60, 0)', borderRadius:'0.3em 0.3em 0em 0em',
        }}
      >
