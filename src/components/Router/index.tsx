...
import PolymerBuilder from "../Polymer/PolymerBuilder";
    ...
    <BrowserRouter>
      <Switch>
        ...
        <Route
          path="/create_account"
          exact
          component={LoadCreateAccountDrawer}
        />
        <Route
          path="/change_password"
          exact
          component={LoadChangePasswordDrawer}
        />
...
function LoadPolymerGenerator(props: RouteComponentProps) {
  ...
  return (
    <WaitForLoginFinish
      ...
      component={PolymerBuilder}
      wait={[Settings.login_promise, Settings.martinize_variables_promise]}
    />
  );
}
